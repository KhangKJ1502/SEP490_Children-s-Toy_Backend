...
public interface IDeliveryRepository
{
    ...
    Task<List<Delivery>> GetBellNotificationsAsync(int accountId, string? status, string? type, int page, int pageSize, CancellationToken ct = default);
    Task<int> CountBellNotificationsAsync(int accountId, string? status, string? type, CancellationToken ct = default);
