...
CREATE TABLE [PriceRanges] (
    ...
    [PriceRangeMin] DECIMAL(18,2) NOT NULL CHECK ([PriceRangeMin] >= 0),
...
CREATE TABLE [Orders] (
    ...
    [VoucherDiscountAmount] DECIMAL(18,2) NOT NULL DEFAULT 0,
    [EstimatedShippingFee]  DECIMAL(18,2) NOT NULL,
    [ActualShippingFee]     DECIMAL(18,2) NULL,
...
CREATE TABLE [CartItems] (
    ...
    [ProductID]       INT NOT NULL,
    [Quantity]        SMALLINT NOT NULL CHECK ([Quantity] > 0),
    [PriceAtThatTime] DECIMAL(18,2) NOT NULL,
...
CREATE TABLE [Vouchers] (
    ...
    [MinOrderAmount]     DECIMAL(18,2) NULL CHECK ([MinOrderAmount] >= 0),
...
CREATE TABLE [OrderVouchers] (
    ...
    [DiscountAmountApplied] DECIMAL(18,2) NOT NULL CHECK ([DiscountAmountApplied] >= 0),
...
CREATE TABLE [OrderRefunds] (
    ...
    [SubTotal]            DECIMAL(18,2) NULL CHECK ([SubTotal] >= 0),
    [TotalAmount]         DECIMAL(18,2) NULL CHECK ([TotalAmount] >= 0),
    ...
    [CustomerShippingPaid] DECIMAL(18,2) NOT NULL CONSTRAINT [DF_OrderRefunds_CustomerShippingPaid] DEFAULT 0,
    [IncludeShippingInRefund] BIT NULL,
    [ItemApprovedSubTotal] DECIMAL(18,2) NOT NULL DEFAULT 0,
    [ItemRejectedSubTotal] DECIMAL(18,2) NOT NULL DEFAULT 0,
    [ReturnToCustomerFee] DECIMAL(18,2) NOT NULL DEFAULT 0,
